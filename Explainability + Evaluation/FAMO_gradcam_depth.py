...
for i, batch in enumerate(test_loader):
    ...
    target_layers = [model.segnet.conv_block_dec[4]]  # Specify target layer for explanation
    ...
    with torch.enable_grad():
        ...
        depth_normalized_rgb = np.stack((depth_normalized.cpu().numpy(),) * 3, axis=-1) 
    ...
    # Save explanatiosn for the first 50 images
    if image_counter <= 50:
